...
public class LoanContractApiController {
	...
	public String save(Model model, String id, String loanContractId,
						String loanContractName, String borrowerType,
						String customerId, String guarantee, BigDecimal loanAmount,
						String periodType, int periodTerm, String loanStartDate,
						String loanEndDate, String rateType, BigDecimal rate,
						String purpose, String industry, String loanType,
						String unionFlag, String payType, String signDate,
						String repaySource, String status, String isExtend) throws ParseException {
		contractService.addNew(id, loanContractId, loanContractName,
				BorrowerTypeEnum.PERSION, customerId, null, loanAmount, 
				PeriodTypeEnum.valueOf(periodType),
				periodTerm, 
				...
				UnionFlagEnum.valueOf(unionFlag), 
				PayTypeEnum.valueOf(payType), 
				DateUtils.parseDate(signDate,"yyyy-MM-dd"),
				repaySource, LoanstatusEnum.valueOf(status), 
				YesNoEnum.valueOf(isExtend));
