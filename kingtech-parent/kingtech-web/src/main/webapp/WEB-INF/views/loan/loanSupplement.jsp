                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
			                    	<form class="form-horizontal" id="form-horizontal" action="loan/add/supplement" method="POST">
										...
										<input type="hidden" id="loanContractId" value="">
										<div class="form-group">
											<label for="#pledgeType" class="col-sm-3 control-label">担保类型</label>
										...
										<div class="form-group">
											<label for="#collateralType" class="col-sm-3 control-label">抵质押物类型</label>
											<div class="col-sm-6 input-group ">
										...
										<div class="form-group">
											<label for="#collateralName" class="col-sm-3 control-label">抵质押物名称</label>
											<div class="col-sm-6 input-group">
												<input type="text" class="form-control validate[required]" name="collateralName" data-errormessage="抵质押物名称不能为空">
											</div>
										</div>
										<div class="form-group">
											<label for="#warrantNum" class="col-sm-3 control-label">权证号</label>
											<div class="col-sm-6 input-group">
												<input type="text" class="form-control" name="warrantNum">
											</div>
										</div>
										<div class="form-group">
											<label for="#evaluationValue" class="col-sm-3 control-label">评估值</label>
											<div class="col-sm-6 input-group">
										...
										<div class="form-group">
											<label for="#warrantHolder" class="col-sm-3 control-label">权证所有人</label>
											<div class="col-sm-6 input-group">
												<input type="text" class="form-control" name="warrantHolder" >
											</div>
										</div>
										<div class="form-group">
											<label for="#collateralAddr" class="col-sm-3 control-label">抵质押物放置位置</label>
											<div class="col-sm-6 input-group">
												<input type="text" class="form-control" name="collateralAddr" >
											</div>
										</div>
										<div class="form-group">
											<label for="#handleDate" class="col-sm-3 control-label">办理抵质押日期</label>
											<div class="col-sm-6 input-group">
										...
										<hr />
										<div class="form-group">
											<label for="#repayDate" class="col-sm-3 control-label">还款日期</label>
										...
										<div class="form-group">
											<label for="#principal" class="col-sm-3 control-label">还款本金</label>
											<div class="col-sm-6 input-group">
												<span class="input-group-addon"><i class="fa fa-rmb"></i></span>
										...
										<div class="form-group">
											<label for="#interest" class="col-sm-3 control-label">还款利息</label>
											<div class="col-sm-6 input-group">
												<span class="input-group-addon"><i class="fa fa-rmb"></i></span>
										...
										<hr />
										<div class="form-group">
											<label for="#principal" class="col-sm-3 control-label">放款金额</label>
											<div class="col-sm-6 input-group">
												<span class="input-group-addon"><i class="fa fa-rmb"></i></span>
												<input type="text" class="form-control validate[required,custom[number]]" name="principal" data-errormessage="放款金额只能为数字">
												<span class="input-group-addon"><i class="fa">元</i></span>
											</div>
										</div>
										<div class="form-group">
											<label for="#repayDate" class="col-sm-3 control-label">放款日期</label>
											<div class="col-sm-6 input-group date">
												<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
												<input type="text" class="form-control pull-right datepicker validate[required]" name="repayDate"
										...
										<div class="form-group">
											<label for="#debtStartDate" class="col-sm-3 control-label">本笔放款债项开始日</label>
											<div class="col-sm-6 input-group date">
												<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
										...
										<div class="form-group">
											<label for="#debtEndDate" class="col-sm-3 control-label">本笔放款债项结束日</label>
											<div class="col-sm-6 input-group date">
												<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
